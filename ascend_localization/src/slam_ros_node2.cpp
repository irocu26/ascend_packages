...
public:
      ...
      returning_(false)
    {
        ...
        coord_file_.open("/home/saakshi-v/image_coords.txt");
        coord_file_ << "# image_file  ekf_x(m)  ekf_y(m)  ekf_z(m)  "
                       "slam_x  slam_y  slam_z  scale\n";
        coord_file_.flush();

        // ── image save directory ──
        system("mkdir -p /home/saakshi-v/slam_images");
    ...
    const nav_msgs::msg::Odometry::SharedPtr msg)
{
    ...
    void image_callback(const sensor_msgs::msg::Image::SharedPtr msg)
    {
        ...
        if(moved_since_save >= 0.10 && ekf_origin_set_)
        {
            image_count_++;

            // filename: slam_images/frame_0001.png
            ostringstream fname;
            fname << "/home/saakshi-v/slam_images/frame_"
